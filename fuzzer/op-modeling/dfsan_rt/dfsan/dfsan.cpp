...
int get_variable_real_label(int lb) {
  return  lb >> 20;
}
...
__dfsan_union(dfsan_label l1, dfsan_label l2) {
  ...
  // if (l2 > 1048576 || l1 > 1048576) {
  //   printf("__dfsan_union #####\n");
  //   printf("origin label lb1 = %d, lb2 = %d, result = %d\n", l1, l2, l3);
  //   printf("variable label l1 = %d, l2 = %d, result = %d\n", get_variable_real_label(l1), get_variable_real_label(l2), get_variable_real_label(l3));
  //   printf("##################\n");
  // }
...
dfsan_label __dfsan_union_load(const dfsan_label *ls, uptr n) {
  // printf("dfsan union load\n");
  if (!ls) return 0;
  dfsan_label ret = __angora_tag_set_combine_n(ls, (uint32_t)n, true);
  // if (ret > 1048576) {
  //   printf("__dfsan_union_load #####\n");
  //   printf("origin label lb = %d\n", ret);
  //   printf("variable label lb = %d\n", get_variable_real_label(ret));
  //   printf("##################\n");
  // }
  return ret;
}
...
extern "C" SANITIZER_INTERFACE_ATTRIBUTE
dfsan_label option_variable_tag_set_insert(int pos) {
  // return __dfsan_tag_set->insert(pos);
  return __option_variable_tag_set_insert(pos);
}
